package heven.holt.kcomponent.user.converter
    ...
    override fun <R> onConvert(succeed: Type, response: Response): R? {
        try {
            ...
            when {
                ...
                code >= 500 -> throw ServerResponseException(response, code.toString()) // 服务器响应错误
                else -> throw ConvertException(response) // 其他错误
            }
        }
    }
